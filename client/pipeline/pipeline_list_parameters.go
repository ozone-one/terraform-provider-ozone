...
// WithXWorkspaceID adds the xWorkspaceID to the pipeline list params
func (o *PipelineListParams) WithXWorkspaceID(xWorkspaceID string) *PipelineListParams {
	o.SetXWorkspaceID(xWorkspaceID)
	return o
}

// SetXWorkspaceID adds the xWorkspaceId to the pipeline list params
func (o *PipelineListParams) SetXWorkspaceID(xWorkspaceID string) {
	o.XWorkspaceID = xWorkspaceID
}

// WithEnd adds the end to the pipeline list params
func (o *PipelineListParams) WithEnd(end *int64) *PipelineListParams {
	o.SetEnd(end)
	return o
}

// SetEnd adds the end to the pipeline list params
func (o *PipelineListParams) SetEnd(end *int64) {
	o.End = end
}

// WithOrder adds the order to the pipeline list params
func (o *PipelineListParams) WithOrder(order *string) *PipelineListParams {
	o.SetOrder(order)
	return o
}

// SetOrder adds the order to the pipeline list params
func (o *PipelineListParams) SetOrder(order *string) {
	o.Order = order
}

// WithSort adds the sort to the pipeline list params
func (o *PipelineListParams) WithSort(sort *string) *PipelineListParams {
	o.SetSort(sort)
	return o
}

// SetSort adds the sort to the pipeline list params
func (o *PipelineListParams) SetSort(sort *string) {
	o.Sort = sort
}

// WithStart adds the start to the pipeline list params
func (o *PipelineListParams) WithStart(start *int64) *PipelineListParams {
	o.SetStart(start)
	return o
}

// SetStart adds the start to the pipeline list params
func (o *PipelineListParams) SetStart(start *int64) {
	o.Start = start
}

// WithID adds the id to the pipeline list params
func (o *PipelineListParams) WithID(id *string) *PipelineListParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the pipeline list params
func (o *PipelineListParams) SetID(id *string) {
	o.ID = id
}

// WithName adds the name to the pipeline list params
func (o *PipelineListParams) WithName(name *string) *PipelineListParams {
	o.SetName(name)
	return o
}

// SetName adds the name to the pipeline list params
func (o *PipelineListParams) SetName(name *string) {
	o.Name = name
}

// WithNameSlug adds the nameSlug to the pipeline list params
func (o *PipelineListParams) WithNameSlug(nameSlug *string) *PipelineListParams {
	o.SetNameSlug(nameSlug)
	return o
}

// SetNameSlug adds the nameSlug to the pipeline list params
func (o *PipelineListParams) SetNameSlug(nameSlug *string) {
	o.NameSlug = nameSlug
}

// WithQ adds the q to the pipeline list params
func (o *PipelineListParams) WithQ(q *string) *PipelineListParams {
	o.SetQ(q)
	return o
}

// SetQ adds the q to the pipeline list params
func (o *PipelineListParams) SetQ(q *string) {
	o.Q = q
}

// WithRegistryID adds the registryID to the pipeline list params
func (o *PipelineListParams) WithRegistryID(registryID *string) *PipelineListParams {
	o.SetRegistryID(registryID)
	return o
}

// SetRegistryID adds the registryId to the pipeline list params
func (o *PipelineListParams) SetRegistryID(registryID *string) {
	o.RegistryID = registryID
}

// WithRepositoryID adds the repositoryID to the pipeline list params
func (o *PipelineListParams) WithRepositoryID(repositoryID *string) *PipelineListParams {
	o.SetRepositoryID(repositoryID)
	return o
}

// SetRepositoryID adds the repositoryId to the pipeline list params
func (o *PipelineListParams) SetRepositoryID(repositoryID *string) {
