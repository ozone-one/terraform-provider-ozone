...
type PipelineListOK struct {
	...
	Payload *models.PipelineList
}

func (o *PipelineListOK) Error() string {
	return fmt.Sprintf("[GET /admin/pipeline][%d] pipelineListOK  %+v", 200, o.Payload)
}
func (o *PipelineListOK) GetPayload() *models.PipelineList {
	return o.Payload
}
...
func (o *PipelineListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.PipelineList)
...
func (o *PipelineListBadRequest) Error() string {
	return fmt.Sprintf("[GET /admin/pipeline][%d] pipelineListBadRequest  %+v", 400, o.Payload)
}
func (o *PipelineListBadRequest) GetPayload() interface{} {
	return o.Payload
}
...
func (o *PipelineListNotFound) Error() string {
	return fmt.Sprintf("[GET /admin/pipeline][%d] pipelineListNotFound  %+v", 404, o.Payload)
}
func (o *PipelineListNotFound) GetPayload() interface{} {
	return o.Payload
}
...
func (o *PipelineListInternalServerError) Error() string {
	return fmt.Sprintf("[GET /admin/pipeline][%d] pipelineListInternalServerError  %+v", 500, o.Payload)
}
func (o *PipelineListInternalServerError) GetPayload() interface{} {
	return o.Payload
}
