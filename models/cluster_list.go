...
func (m *ClusterList) validateItems(formats strfmt.Registry) error {
...
func (m *ClusterList) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
