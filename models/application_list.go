...
type ApplicationList struct {
	...
	// items
	Items []*GithubComOzoneCloudCommonEntitiesApplicationApplication `json:"items"`
}
...
func (m *ApplicationList) validateItems(formats strfmt.Registry) error {
...
func (m *ApplicationList) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
