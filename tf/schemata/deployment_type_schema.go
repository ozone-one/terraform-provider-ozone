...
func SetDeploymentTypeSubResourceData(m []*models.DeploymentType) (d []*map[string]interface{}) {
	for _, deploymentType := range m {
		if deploymentType != nil {
			properties := make(map[string]interface{})
			properties["created_at"] = deploymentType.CreatedAt
			properties["deleted_at"] = deploymentType.DeletedAt
			properties["id"] = deploymentType.ID
			properties["name"] = deploymentType.Name
			properties["updated_at"] = deploymentType.UpdatedAt
